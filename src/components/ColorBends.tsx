...
export default function ColorBends({
  ...
  useEffect(() => {
    ...
    /* Honour the OS "reduce motion" setting. A full-screen shader that never
       stops moving is exactly the kind of thing that setting exists for; the
       first frame still paints, so the backdrop looks intentional rather than
       blank. */
    const reduceMotion =
